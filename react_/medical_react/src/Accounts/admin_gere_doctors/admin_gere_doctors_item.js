...
export default function Gerer_Doctor_ByAdmin_Item(props){
    ...
    return (
        <div className="card_doctor">
            ...
            <div className="card_div"><div className="card_text">Email: </div><div className="card_text">{props.doctor.email}</div></div>
            <div className="card_div"><div className="card_text">Age: </div><div className="card_text">{props.doctor.age}</div></div>
